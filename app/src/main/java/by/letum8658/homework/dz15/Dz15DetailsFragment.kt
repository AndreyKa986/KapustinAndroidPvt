...
class Dz15DetailsFragment : Fragment(), Dz11DetailsView {

    companion object {

        private const val ID_KEY = "id_key"

        fun getInstance(id: String): Dz15DetailsFragment {
            val fragment = Dz15DetailsFragment()
            val bundle = Bundle()
    ...
    private val presenter = Dz15DetailsPresenter()
